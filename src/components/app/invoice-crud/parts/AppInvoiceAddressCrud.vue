  ...
  <div class="space-y-8">
    <div class="flex gap-3">
      <base-label-input
        class="w-full"
        id="firm_title"
        label="İşletme Unvanı"
        v-model="modalForm.firmTitle"
      />
      <base-label-input
        class="w-full"
        id="address"
    ...
    <div class="flex gap-3">
      <base-label-input
        ...
        id="tax_office"
        label="Vergi Dairesi"
        v-model="modalForm.taxOffice"
      />
      <base-label-input
        class="w-full"
        id="identity_no"
        label="VKN"
        v-model="modalForm.identityNo"
      />
    </div>
  </div>
</template>
...
export default {
  name: "AppInvoiceAddressCrud",
  components: { BaseLabelInput },
  computed: {
